...
void create_predefined_symbols(agent* thisAgent)
{
    ...
    thisAgent->rl_over_threshold_constant = make_str_constant(thisAgent, "over-threshold"); ///< bazald
    ...
    thisAgent->rl_sym_terminal = make_str_constant(thisAgent, "terminal"); ///< bazald
...
void release_predefined_symbols(agent* thisAgent)
{
    ...
    release_helper(thisAgent, &(thisAgent->rl_over_threshold_constant)); ///< bazald
    ...
    release_helper(thisAgent, &(thisAgent->rl_sym_terminal)); ///< bazald
