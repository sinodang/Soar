...
bool CommandLineInterface::DoRL(const char pOp, const std::string* pAttr, const std::string* pVal)
{
    ...
    if (!pOp)
    {
     ...
     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "eligibility-trace-type: ", thisAgent->rl_params->et_type->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "tsdt-cutoff: ", thisAgent->rl_params->tsdt_cutoff->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "rl-impasse: ", thisAgent->rl_params->rl_impasse->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine: ", thisAgent->rl_params->refine->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine-stddev: ", thisAgent->rl_params->refine_stddev->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine-require-episodes: ", thisAgent->rl_params->refine_require_episodes->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine-decay-rate: ", thisAgent->rl_params->refine_decay_rate->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine-cycles-between-episodes: ", thisAgent->rl_params->refine_cycles_between_episodes->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "refine-reinhibit: ", thisAgent->rl_params->refine_reinhibit->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "credit-assignment: ", thisAgent->rl_params->credit_assignment->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "credit-modification: ", thisAgent->rl_params->credit_modification->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result,
            CLI_DoRL_generate_output( "variance-bellman: ", thisAgent->rl_params->variance_bellman->get_string() ) );

     CLI_DoRL_print( *this, m_RawOutput, m_Result, "" );

     std::ostringstream ss;
     ss << "agent's running variance: " << thisAgent->variance;
     CLI_DoRL_print( *this, m_RawOutput, m_Result, const_cast<char *>(ss.str().c_str()) );

     ss.str("");
     ss << "agent's running second order variance: " << thisAgent->variance_variance;
     CLI_DoRL_print( *this, m_RawOutput, m_Result, const_cast<char *>(ss.str().c_str()) );
